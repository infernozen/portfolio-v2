  ...
  return (
    ...
    >
      <div className="flex flex-row items-center mb-6">
        <div className="w-[56px] h-[56px] p-1 rounded-full bg-white flex items-center justify-center">
          <img
            src={props.logo}
        ...
        <h4 className="font-poppins font-semibold text-[20px] text-gradient leading-[32px] ml-3">
          {props.organisation}
        </h4>
      </div>
